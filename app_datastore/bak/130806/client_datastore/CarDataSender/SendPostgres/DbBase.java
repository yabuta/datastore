...
public class DbBase {
	...
	private static final String dbHost = "db1.ertl.jp";
    ...
    public String[] SelectQuery(String query,String dataType)
    {
	try{
	    Statement stmt = con.createStatement();
		...
		for(int i = 0;i < dt.length; i++){
		    res[count] = res[count] + rs.getString(dt[i]);
		    res[count] = res[count] + ",";
		}
		res[count] = res[count].substring(0,res[count].length()-1);
